...
public class DlgCircle extends JDialog {
	...
	private JButton btnInnerColorCircle;
	private JButton btnOutlineColorCircle;
	...
	public DlgCircle() {
							...
							try {
								if (Integer.parseInt(txtX.getText()) < 0 || Integer.parseInt(txtY.getText()) < 0
									...
									circle = new Circle(
											...
											Integer.parseInt(txtR.getText()), false, btnOutlineColorCircle.getBackground(),
											btnInnerColorCircle.getBackground()
		...
		}
		{
			...
			{
				btnInnerColorCircle = new JButton("Inner Color");
				btnInnerColorCircle.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						Color innerColor = JColorChooser.showDialog(null, "Choose the inner color of the circle.",
								btnInnerColorCircle.getBackground());
						if (innerColor != null) {
							btnInnerColorCircle.setBackground(innerColor);
						}
					}
				});
				...
				pnlCenter.add(btnInnerColorCircle, gbc_btnInnerColor);
			}
			{
				btnOutlineColorCircle = new JButton("Outline Color");
				btnOutlineColorCircle.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						Color outlineColor = JColorChooser.showDialog(null, "Choose the otuline color of the circle.",
								btnOutlineColorCircle.getBackground());
						if (outlineColor != null) {
							btnOutlineColorCircle.setBackground(outlineColor);
						}
					}
				});
				...
				pnlCenter.add(btnOutlineColorCircle, gbc_btnOutlineColor);
			}
		}
	...
	public JButton getBtnInnerColorCircle() {
		return btnInnerColorCircle;
	}

	public void setBtnInnerColorCircle(JButton btnInnerColorCircle) {
		this.btnInnerColorCircle = btnInnerColorCircle;
	}

	public JButton getBtnOutlineColorCircle() {
		return btnOutlineColorCircle;
	}

	public void setBtnOutlineColorCircle(JButton btnOutlineColorCircle) {
		this.btnOutlineColorCircle = btnOutlineColorCircle;
	}
